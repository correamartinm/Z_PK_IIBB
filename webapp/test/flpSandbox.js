		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IIBB Caba",
									"targetURL": "#zpkiibbzpkiibb-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpkiibbzpkiibb-display": {
								"semanticObject": "zpkiibbzpkiibb",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpkiibb.zpkiibb",
									"url": sap.ui.require.toUrl("zpkiibb/zpkiibb")
								}
							}
						}
					}
